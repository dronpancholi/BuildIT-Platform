...
@router.get("/infrastructure-self-analysis/infra-self-analysis/topology")
...
@router.get("/infrastructure-self-analysis/infra-self-analysis/bottlenecks")
...
@router.get("/infrastructure-self-analysis/infra-self-analysis/workflow-congestion")
...
@router.get("/infrastructure-self-analysis/infra-self-analysis/queue-health-forecast")
...
@router.get("/infrastructure-self-analysis/infra-self-analysis/degradation")
